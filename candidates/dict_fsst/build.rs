fn main() {
    ...
    println!("cargo:rustc-link-lib=static=lb_dict_fsst");
    ...
    println!("cargo:rerun-if-changed=cpp/dict_fsst_candidate.cpp");
    println!("cargo:rerun-if-changed=../common/fsst_common/fsst_build.hpp");
    println!("cargo:rerun-if-changed=../common/dict_common/flat_dictionary.hpp");
    println!("cargo:rerun-if-changed=../common/dict_common/bitpacking_size.hpp");
